...
:since:  v0.1.00
		...
		#
			...
			if (resource_recording_status in ( MpEntryPvrRecording.RECORDING_STATUS_FINISHED,
...
:since:  v0.1.00
		...
		if (self.handle_id is not None):
		#
			if (n is None): n = int(Settings.get("pas_global_io_chunk_size_local_network", 1048576))
